          ...
          <Col  className="project-card">
            <ProjectCard
             imagePath = {Student}
              ...
              description="A student mark list system allows teachers to store marks by register and log in. Teachers have the capability to perform CRUD (Create, Read, Update, Delete) operations on the student list. Similarly, students can register and log in using their email. After logging in, students are required to enter their date of birth and roll number to view their results."
          ...
          <Col  className="project-card">
            <ProjectCard
              ...
              description="WeConnect is a one-to-one chat application. Upon logging in, users are directed to the chat page. If no existing chats are found, users can search for another user by entering their email or username. Once the desired user is found, clicking on them opens a one-to-one chat. 
               Users also have the option to delete conversations."
              tech = "ReactJs,NodeJs,ExpressJs,MongoDB"
